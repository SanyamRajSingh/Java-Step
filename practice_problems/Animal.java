...
class Dog extends Mammal {
    ...
    public Dog() {
        super("Dog", "Domestic", 15, false, "Varies", 60);
        this.breed = "Mixed";
    ...
    public Dog(Dog other) {
        this(other.species, other.habitat, other.lifespan, other.isWildlife, other.furColor,
                other.gestationPeriod, other.breed, other.isDomesticated, other.loyaltyLevel, other.favoriteActivity);
    }
    ...
    public void demonstrateInheritance() {
        ...
        nurse();
        regulateTemperature();
        System.out.println("Breed: " + breed + ", Domesticated: " + isDomesticated + ", Favorite Activity: " + favoriteActivity);
    }
    ...
    public static void main(String[] args) {
        ...
        Dog detailedDog = new Dog("Dog", "Domestic", 14, false, "Brown", 58,
                "Labrador", true, 10, "Swimming");
        detailedDog.demonstrateInheritance();

        System.out.println("\nCreating Dog via copy constructor:");
